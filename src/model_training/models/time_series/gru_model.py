...
class GRULightningModule(pl.LightningModule):
    """PyTorch Lightning module for GRU model."""
    ...
    def __init__(
        ...
        """
        Initialize GRU Lightning module.
...
class GRUTimeSeriesForecaster:
    """GRU-based time series forecaster for cryptocurrency price prediction."""
    
    def __init__(self, config: TrainingConfig):
        """
        Initialize GRU time series forecaster.
    ...
    def train(
        ...
        # Configure logger
        logger = TensorBoardLogger("lightning_logs", name=self.config.experiment_name or "gru_model")
    ...
    def load(self, filepath: str) -> None:
        ...
        # Create model
        self.model = GRULightningModule(**checkpoint["hyperparameters"])
